...
<body class=" mx-auto bg-slate-400">
    <?php include("navbar.php") 
    ?>
    <div class="container mx-auto bg-slate-400 ">
        <h1 class="text-2xl bg-slate-500 font-semibold p-1">+ Ajouter Une Seance Se Rattrapage</h1>
        <form action="ajouterrattrapage.php" method="post" class="pl-10 flex flex-row">
    ...
    <div class="container mx-auto">
        ...
        <div>
            <?php
            $seances = db_select("seance","*","id_enseignant = '".$_SESSION["LOGGED"]["id_utilisateur"]."' and rattrapage = '1'");
            ?>
